...
<div class="container main-content">
  ...
  <table style="border:2px solid black" class="table table-bordered">
    <tr style="border:2px solid black">
      <tr>
        <td style="width:16%"></td><td style="width:16%"></td><td style="width:16%"></td><td style="width:16%"></td><td style="width:16%"></td><td style="width:16%"></td>
      </tr>
        <?php
              ...
              for($i = 0;$i<11;$i++){
                ...
                if($i<2){
                  ...
                  echo "<td class='once arribaBorde derechoBorde' style='padding:0;' colspan='1'></td>";
                    ...
                    if($i == 10){
                      echo "<td class='once arribaBorde derechoBorde' style='padding:0' colspan='4'>Otros</td>";
                    }
                }
                echo "</tr>";
              }
