...
//  echo "<div id='color1'><a href='$RegistroDiario'id='co'>Registro Diario</a>></div>"; ?>
   ...
   <div class="row">
     ...
     <div class="col-auto mb-2" title="Registro Diario">
       <button type="button" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#registroDiarioModal"
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="registroDiarioModalLabel">REGISTRO DIARIO DE PACIENTES</h5>
   ...
   */
   ...
   function buscarResponsableAdmision() {
     ...
     "Fecha de Retorno: " + fechaderetornodeHistoria
               ...
               //alert(data+"dasdas");
                 ...
                 if(data == "correcto"){
                   ...
                   //}else{
                     alertCorrecto();
                   //}
                   IRalLinkTablaRegistroDiario(cod_rd);
                 }else {
                   Swal.fire({
                    icon: 'error',
                    title: '¡Error!',
           ...
           function IRalLinkTablaRegistroDiario(cod_rd){
             //alert(cod_rd);
             if(cod_rd!=''){
               setTimeout(() => {
                 ...
                 $('#registroDiarioModal').modal('hide');
               }, 1500);
             }else{
               setTimeout(() => {
                 $('#registroDiarioModal').modal('hide');
