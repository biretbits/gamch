                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h6 class="modal-title" id="miModalRegistro"style="color:dimgray">REGISTRO FORMA DE PRESENTACIÓN</h6>
...
function Buscar(page){
    ...
    datos.append("buscar",buscar);
      $.ajax({
        url: "../controlador/farmacia.controlador.php?accion=bpt",
        type: "POST",
        data: datos,
  ...
  function registrar(){
    ...
    datos.append('cod_generico',cod_generico);
      $.ajax({
        url: "../controlador/farmacia.controlador.php?accion=rp",
        type: "POST",
        data: datos,
        contentType: false, // Deshabilitar la codificación de tipo MIME
        processData: false, // Deshabilitar la codificación de datos
        success: function(data) {
          ...
          if(data == 'correcto'){
            ...
            Error1();
          }else{//esto es cuando no llega ni error ni correcto u otro si no que esta viniendo despues de que el admin cerro su session
            cod_generico='';
          }
  ...
  function reporte(){
    ...
    var form = document.createElement('form');
     form.method = 'post';
     form.action = '../controlador/farmacia.controlador.php?accion=rpr'; // Coloca la URL de destino correcta
