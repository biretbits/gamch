...
<div class="container">
  ...
  <div id="cambiar">
  <h6 align='center'>Cantidad de pacientes atendidos por servicio
...
function Buscar(){
  ...
  var fechaf = document.getElementById("fechaf").value;
    ...
    datos.append('fechaf', fechaf);
      $.ajax({
        url: "../controlador/servicio.controlador.php?accion=bfs",
        type: "POST",
        data: datos,
  ...
  function GenerarReportesServicio(){
    ...
    var form = document.createElement('form');
     form.method = 'post';
     form.action = '../controlador/servicio.controlador.php?accion=gfrs'; // Coloca la URL de destino correcta
