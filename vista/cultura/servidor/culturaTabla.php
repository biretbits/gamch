      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title" id="miModalRegistro"style="color:dimgray">CULTURA</h6>
               ...
               <form>
                 ...
                 <div class="mb-3">
                   <label for="">Nombre de la Actividad</label>
                    <input type="text" class="form-control" id="nombre_actividad" name='nombre_actividad' placeholder="Ponga la Actividad" required>
                 </div>
                 <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="tipo_actividad">Tipo de Actividad Cultural:</label>
                ...
                <div class="mb-3">
                  ...
                  <input type="date"name="name" rows="8" cols="80" id='fecha_inicio' class="form-control">
               </div>
               <div class="mb-3">
