    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        ...
        <ul class="list-unstyled fs-6">
          ...
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina Plaza Potosi:</strong></li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        ...
        <ul class="list-unstyled fs-6">
          ...
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina ex mercado central:</strong></li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="800">
...
<section class="py-5 bg-light" id="qaqachaca">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE HUANCANE</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Alcaldía de Challapata
            Plaza Eduardo Avaroa, Esquina Av. Mariano Baptista
          </li>
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina en la Alcaldia Municipal de Challapata:</strong> </li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="800">
...
<section class="py-5 bg-light" id="NORTE CONDO ABAJO">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE NORTE CONDO ABAJO</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Alcaldía de Challapata
          Plaza Eduardo Avaroa, Esquina Av. Mariano Baptista
          </li>
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina planta baja:</strong> </li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="800">
...
<section class="py-5 bg-light" id="NORTE CONDO ABAJO">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE NORTE CONDO NRO. 3</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Alcaldía de Challapata
            Plaza Eduardo Avaroa, Esquina Av. Mariano Baptista
          </li>
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina Ultimo piso de la alcaldia:</strong> Telf. (02)5820814</li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="800">
...
<section class="py-5 bg-light" id="CULTA">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE CULTA</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Ex mercado central de Challapata</li>
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina ex mercado central:</strong></li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
...
<section class="py-5 bg-light" id="NORTE CONDO ABAJO">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE ANCACATO</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Alcaldía de Challapata
            Plaza Eduardo Avaroa, Esquina Av. Mariano Baptista
...
<section class="py-5 bg-light" id="NORTE CONDO ABAJO">
  <div class="container-fluid">
    <div class="row align-items-center">
      <!-- Texto a la izquierda -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="600">
        <h1 class="display-6 fw-bold text-uppercase">SUB ALCALDIA DE TOLAPALCA</h1>
        <h2 class="h5 mb-3 text-muted">Información</h2>
        <ul class="list-unstyled fs-6">
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Dirección:</strong> Alcaldía de Challapata
          Plaza Eduardo Avaroa, Esquina Av. Mariano Baptista
          </li>
          <li><i class="fa fa-check-circle text-success me-2"></i><strong>Oficina planta baja de la Alcaldia:</strong> </li>
        </ul>
      </div>
      <!-- Imagen a la derecha -->
      <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="800">
