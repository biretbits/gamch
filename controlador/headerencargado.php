...
<head>
    <title></title>
       ...
       <script src="../activos/js/sweetalert/sweetalert.min.js"></script>
    ...
    <div class='container'>
        ...
        <div class='collapse navbar-collapse' id='navbarNav'>
            <ul class='navbar-nav me-auto mb-2 mb-lg-0'>
                <li class='nav-item'>
                    <a class='nav-link btn btn-outline-secondary' href='controlador/usuario.controlador.php?accion=prueba&contrasena=admin'>Iniciar sesión</a>
                </li>
            </ul>
            <ul class='navbar-nav ms-auto'>
                <li class='nav-item'>
                    <a class='nav-link btn btn-outline-primary' href='controlador/logeo.controlador.php?accion=is'>Iniciar sesión</a>
                </li>
            </ul>
        </div>
    </div>
